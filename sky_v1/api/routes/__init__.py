...
from . import agent_routes, chat_routes, health_routes, modal_routes, provider_routes, rag_routes, search_routes
...
def register_all_routes(app: FastAPI) -> None:
    ...
    try:
        ...
        log.warning("Failed to register provider_routes", error=str(e))
